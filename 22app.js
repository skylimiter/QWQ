...
function list(path) {
    ...
    <div class="mdui-row">
        ...
        <div id="count" class="mdui-hidden mdui-center mdui-text-center mdui-m-b-3 mdui-typo-subheading mdui-text-color-blue-grey-500">共 <span class="number"></span> 項<br><a href="https://www.youtube.com/watch?v=nDbNRb9gOr4&loop=0"><img src="https://i.postimg.cc/52PqZ84M/image.png" width="100" height="100"></a>
        <br><a id="back-to-top" href="#">返回頂部</a></div>
    </div>
