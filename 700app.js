...
function nav(path) {
    ...
    let search_text = model.is_search_page ? model.q || '' : '',
        search_bar = `<div class="mdui-toolbar-spacer"></div>
            ...
            <a href="//twitter.com/TW_NEKO_CHAN" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: \'Twitter\'}" alt="Twitter"><img src="//image.flaticon.com/icons/svg/1384/1384075.svg" width="30" height="45" >
            </button>
        </div>`
