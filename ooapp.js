...
function nav(path) {
    ...
    let search_text = model.is_search_page ? model.q || '' : '',
        search_bar = `<div class="mdui-toolbar-spacer"></div>
            <a href="//discord.com/invite/XrAa7RDBhw" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: \'點我加入群組！\'}" alt="點我加入群組！"><img src="https://i.postimg.cc/NF9g6Vqv/image.png" width="45" height="45"></a>
